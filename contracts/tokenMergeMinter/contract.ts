...
export interface TokenMergeMinterInstance {
  readonly contractAddress: string
...
export interface TokenMergeMinterMessages {
...
export interface TokenMergeMinterContract {
  instantiate: (
  ...
  use: (contractAddress: string) => TokenMergeMinterInstance

  messages: (contractAddress: string) => TokenMergeMinterMessages
}

export const tokenMergeMinter = (client: SigningCosmWasmClient, txSigner: string): TokenMergeMinterContract => {
  const use = (contractAddress: string): TokenMergeMinterInstance => {
    //Query
