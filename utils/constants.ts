...
export const VENDING_IBC_INIT_FACTORY_ADDRESS = process.env.NEXT_PUBLIC_VENDING_IBC_INIT_FACTORY_ADDRESS
export const FEATURED_VENDING_IBC_INIT_FACTORY_ADDRESS =
  process.env.NEXT_PUBLIC_FEATURED_VENDING_IBC_INIT_FACTORY_ADDRESS
export const VENDING_IBC_INIT_UPDATABLE_FACTORY_ADDRESS =
  process.env.NEXT_PUBLIC_VENDING_IBC_INIT_UPDATABLE_FACTORY_ADDRESS

export const VENDING_IBC_INIT_FACTORY_FLEX_ADDRESS = process.env.NEXT_PUBLIC_VENDING_IBC_INIT_FACTORY_FLEX_ADDRESS
export const FEATURED_VENDING_IBC_INIT_FACTORY_FLEX_ADDRESS =
  process.env.NEXT_PUBLIC_FEATURED_VENDING_IBC_INIT_FACTORY_FLEX_ADDRESS
export const VENDING_IBC_INIT_UPDATABLE_FACTORY_FLEX_ADDRESS =
  process.env.NEXT_PUBLIC_VENDING_IBC_INIT_UPDATABLE_FACTORY_FLEX_ADDRESS
export const VENDING_IBC_INIT_FACTORY_MERKLE_TREE_ADDRESS =
  process.env.NEXT_PUBLIC_VENDING_IBC_INIT_FACTORY_MERKLE_TREE_ADDRESS
export const FEATURED_VENDING_IBC_INIT_FACTORY_MERKLE_TREE_ADDRESS =
  process.env.NEXT_PUBLIC_FEATURED_VENDING_IBC_INIT_FACTORY_MERKLE_TREE_ADDRESS
export const VENDING_IBC_INIT_FACTORY_MERKLE_TREE_FLEX_ADDRESS =
  process.env.NEXT_PUBLIC_VENDING_IBC_INIT_FACTORY_MERKLE_TREE_FLEX_ADDRESS
export const FEATURED_VENDING_IBC_INIT_FACTORY_MERKLE_TREE_FLEX_ADDRESS =
  process.env.NEXT_PUBLIC_FEATURED_VENDING_IBC_INIT_FACTORY_MERKLE_TREE_FLEX_ADDRESS
...
export const OPEN_EDITION_IBC_INIT_FACTORY_MERKLE_TREE_ADDRESS =
  process.env.NEXT_PUBLIC_OPEN_EDITION_IBC_INIT_FACTORY_MERKLE_TREE_ADDRESS
export const OPEN_EDITION_IBC_INIT_FACTORY_MERKLE_TREE_FLEX_ADDRESS =
  process.env.NEXT_PUBLIC_OPEN_EDITION_IBC_INIT_FACTORY_MERKLE_TREE_FLEX_ADDRESS
export const OPEN_EDITION_IBC_INIT_FACTORY_ADDRESS = process.env.NEXT_PUBLIC_OPEN_EDITION_IBC_INIT_FACTORY_ADDRESS
export const OPEN_EDITION_IBC_INIT_FACTORY_FLEX_ADDRESS =
  process.env.NEXT_PUBLIC_OPEN_EDITION_IBC_INIT_FACTORY_FLEX_ADDRESS
export const OPEN_EDITION_UPDATABLE_IBC_INIT_FACTORY_ADDRESS =
  process.env.NEXT_PUBLIC_OPEN_EDITION_UPDATABLE_IBC_INIT_FACTORY_ADDRESS
