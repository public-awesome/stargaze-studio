...
import { ibcInit, tokensList } from '../../config/token'
...
const CollectionCreationPage: NextPage = () => {
  ...
  const [mintTokenFromOpenEditionFactory, setMintTokenFromOpenEditionFactory] = useState<TokenInfo | undefined>(ibcInit)
  const [mintTokenFromVendingFactory, setMintTokenFromVendingFactory] = useState<TokenInfo | undefined>(ibcInit)
