...
export const gaze: TokenInfo = {
  id: 'gaze',
  denom: 'ugaze',
  displayName: 'GAZE',
  decimalPlaces: 6,
  imageURL: 'https://raw.githubusercontent.com/initia-labs/initia-registry/main/testnets/intergaze/images/logo.svg',
}

export const ibcInit: TokenInfo = {
  id: 'ibc-init',
  denom:
    NETWORK === 'mainnet'
...
export const tokensList = [gaze, ibcInit]
